...
namespace DotNetNuke.Extensions.Data
{
    ...
    /// </summary>
    /// <see cref="http://blog.wekeroad.com/helpy-stuff/and-i-shall-call-it-massive"/>
    public class DynamicModel : DynamicObject
    {
        ...
        /// <summary>
        /// Opens the specified connection string name.
        /// </summary>
        ...
        {
            TableName = DotNetNuke.Data.DataProvider.Instance().ObjectQualifier + tableName == "" ? GetType().Name : tableName;
            PrimaryKeyField = string.IsNullOrEmpty(primaryKeyField) ? "ID" : primaryKeyField;            
            string providerName = DotNetNuke.Data.DataProvider.Instance().ProviderName;
